<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Settings.aspx.cs" Inherits="User_Settings" %>
...
<div class="well">
    	...
    	<table class="newsleft" style="border-spacing:0 15px;">
            <tr>
                ...
                <td>  <asp:TextBox ID="txt_cpwd" runat="server" Width="375px" TextMode="Password" ></asp:TextBox>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>New Password</td>
                <td> <asp:TextBox ID="txt_npwd" runat="server" Width="375px" TextMode="Password"></asp:TextBox>
</td>
                <td class="auto-style1">&nbsp;</td>
            </tr>
              <tr>
            ...
            <tr>
                ...
                <td> <asp:TextBox ID="txt_conpwd" runat="server" Width="375px" TextMode="Password"></asp:TextBox>
</td>
                <td class="auto-style1">&nbsp;</td>
            </tr>
            <tr>
