<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditProfile.aspx.cs" Inherits="User_EditProfile" %>
						...
						<div style="align: center; margin-top: -18px; margin-left:25px;">
                            <%--<form action="search">--%>
									...
									<li class="dropdown notification-menu">
                                        ...
                                        <asp:LinkButton ID="lb_ser" runat="server" class="fa fa-search" style="margin-left: -4px; height: 15px;"  Width="18px" OnClick="lb_ser_Click"></asp:LinkButton>
...
<div class="well">
    	...
    	<table class="newsleft" style="border-spacing:0 15px;">
            <tr>
                <td>&nbsp;</td>
                <td>Firstname</td>
                <td>  <asp:TextBox ID="txt_fname" runat="server" Width="375px"></asp:TextBox>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>Lastname</td>
                <td> <asp:TextBox ID="txt_lname" runat="server" Width="375px"></asp:TextBox>
</td>
                <td class="auto-style1">&nbsp;</td>
            </tr>
              <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RadioButtonList ID="rbl_gender"  runat="server" Width="375px" RepeatDirection="Horizontal">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>DOB</td>
                <td>                                     <asp:TextBox ID="txt_dob"   runat="server" TextMode="DateTime" Width="375px" ></asp:TextBox>
             ...
             <tr>
                ...
                <td> 
                                                        ...
                                                        <asp:TextBox ID="txt_mobile"  MaxLength="10" runat="server" Width="375px" ></asp:TextBox>
             ...
             <tr>
                ...
                <td>&nbsp;</td>
                <td>Email</td>
                <td>                     <asp:TextBox ID="txt_email"   type="email" runat="server" Width="375px" required="" ></asp:TextBox>
...
<%--    	<label>Current Password</label>
    ...
    <br />--%>
	    ...
	    <asp:LinkButton ID="lnk_submit" runat="server"  Class="btn btn-primary" OnClick="lnk_submit_Click" >Update</asp:LinkButton>
