<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Profile1.aspx.cs" Inherits="User_Profile" %>
...
&nbsp;
        ...
        <asp:FileUpload ID="fu_bgimg" runat="server" style="position:absolute; background-color:white;color:white;border-color:black;
   top: 130px;
    left: 148px; width: 102px;" />
...
<%--        <asp:ImageButton ID="ib_submit"  runat="server" ImageUrl="~/camera-icon-21.png" style=" background-color:white;color:black;border-color:black;" CssClass="auto-style1" OnClick="ib_submit_Click" />--%>

        <asp:LinkButton ID="lb_bgimg" runat="server" style=" background-color:white;color:black;border-color:black;" CssClass="auto-style1" class="fa fa-camera" OnClick="lb_bgimg_Click" > <i class="fa fa-camera" ></i></asp:LinkButton>
	</div>
	</div>
 ...
 <%--   <asp:Button ID="btn_upload" runat="server" Text="Button" />--%>
   ...
   top: 290px;
    left: 140px; width: 102px;" />--%>
        ...
        <asp:FileUpload ID="fu_profimg" runat="server" style=" position: absolute; background-color:white;color:white;border-color:black;
   top: 341px;
    left: 141px; width: 102px;" />

            <asp:LinkButton ID="lb_profpic" runat="server" style=" background-color:white;color:black;border-color:black; top: 344px;
   left:246px; width: 4px;" CssClass="auto-style1" class="fa fa-camera" OnClick="lb_profpic_Click"> <i class="fa fa-camera" ></i></asp:LinkButton>
...
<%--<form action="postcmt">--%>
	...
	<%--<br>
	<c:forEach var="i" items="${vp }">

	<label>${i.post }</label>
<br>

<a href="like?pid=${i.pid }" style="color: #3a4ed5;" class="fa fa-thumbs-o-up">Like</a>
&nbsp;&nbsp;
<a href="comment?pid=${i.pid }" style="color: #3a4ed5;" class="fa fa-comment" onmouseover="setFocusToTextBox()">Comment</a>
&nbsp;&nbsp;<br>
<c:forEach var="j" items="${vc }">
<label style="color: black;">${j.fname }</label><br>
	<label style="color: red;">${j.cmt }</label>
	<br>
	</c:forEach>
	
<img src="../UserTemp/images/${pic }" onerror="this.src='../UserTemp/images/default.jpg'" height="32" width="32">
	<input type="text" id="cm" name="cmt" placeholder="Write a comment....." style="width: 500px;">
	<button type="submit" name="pid" value="${i.pid }" style="background: #2b3aa2; color: white;border-color:#2b3aa2; " >Comment</button>
	<br>
	<br>
