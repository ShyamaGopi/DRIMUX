<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Work.aspx.cs" Inherits="User_Work" %>
...
<div class="well">
    	...
    	<table class="newsleft" style="border-spacing:0 15px;">
            <tr>
                <td>&nbsp;</td>
                <td>Work</td>
                <td>  <asp:TextBox ID="txt_work" runat="server" Width="375px" required=""></asp:TextBox>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>Company</td>
                <td> <asp:TextBox ID="txt_company" runat="server" Width="375px" required=""></asp:TextBox>
</td>
                <td class="auto-style1">&nbsp;</td>
            </tr>
              <tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>Place</td>
                <td> <asp:TextBox ID="txt_Place" runat="server" Width="375px" required=""></asp:TextBox>
</td>
                <td class="auto-style1">&nbsp;</td>
            </tr>
             <tr>
...
<%--    	<label>Current Password</label>
    ...
    <br />--%>
	    ...
	    <asp:LinkButton ID="lnk_submit" runat="server" Class="btn btn-primary" OnClick="lnk_submit_Click1"  >Submit</asp:LinkButton>
