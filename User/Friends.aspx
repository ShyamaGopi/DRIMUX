<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Friends.aspx.cs" Inherits="User_Friends" %>
            ...
            <ItemTemplate>
                <table class="nav-justified">
                    <tr>
                        ...
                        <td>
<%--                            <asp:LinkButton ID="LinkButton2" runat="server"  CommandArgument='<%# Eval("FId") %>' CommandName="Block">Block</asp:LinkButton>--%>
                        </td>
                        <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
                </table>
