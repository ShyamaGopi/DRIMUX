<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Interest.aspx.cs" Inherits="User_Interest" %>
...
<div class="well">
    	...
    	<table class="newsleft" style="border-spacing:0 15px;">
            <tr>
                <td>&nbsp;</td>
                <td>Interest</td>
                <td>  <asp:TextBox ID="txt_intr" runat="server" Width="375px" TextMode="MultiLine"></asp:TextBox>
