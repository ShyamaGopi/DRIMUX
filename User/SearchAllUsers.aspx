<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchAllUsers.aspx.cs" Inherits="User_SearchAllUsers" %>
...
<%--								<input type="text" style="width: 450px; margin-left: 55px;"  name="srh"/>--%>
								
									<li class="dropdown notification-menu"> 
                                          
                                        <asp:LinkButton ID="lb_ser" runat="server" type="submit" class="fa fa-search" style="margin-left: -4px;" OnClick="lb_ser_Click"></asp:LinkButton>
...
<%--	    <asp:LinkButton ID="lnk_submit" runat="server"  Class="btn btn-primary">Submit</asp:LinkButton>--%>
