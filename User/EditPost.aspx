<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditPost.aspx.cs" Inherits="User_EditPost" %>
                            ...
                            <%--<form action="search">--%>
								<asp:TextBox ID="txt_ser" runat="server" type="text" style="width: 450px; margin-left: 55px;"  ></asp:TextBox>
									...
									<li class="dropdown notification-menu">
                                        <asp:LinkButton ID="lb_ser" runat="server" class="fa fa-search" style="margin-left: -4px;"  Width="18px" ></asp:LinkButton>
...
<div class="well">
    	...
    	<table class="newsleft" style="border-spacing:0 15px;">
            <tr>
                <td>&nbsp;</td>
                <td>Post</td>
                <td>  <asp:TextBox ID="txt_post" runat="server" Width="375px"  TextMode="MultiLine"></asp:TextBox>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>Url</td>
                <td> <asp:TextBox ID="txt_url" runat="server" Width="375px" ></asp:TextBox>
</td>
                <td class="auto-style1">&nbsp;</td>
            </tr>
              <tr>
            ...
            <tr>
                ...
                <td>
                     ...
                     <asp:FileUpload ID="fu_img" runat="server" Width="375px" />
             ...
             <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td> <asp:ImageButton ID="ib_img" runat="server" Height="50px" Width="50px"  /></td>
                <td class="auto-style1">&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
