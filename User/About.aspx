<%@ Page Language="C#" AutoEventWireup="true" CodeFile="About.aspx.cs" Inherits="User_About" %>
...
<%--<form action="postcmt">--%>
    ...
    <p class="fa fa-envelope" style="color:blue"><%=Server.HtmlEncode(Session["email"].ToString())%></p>
    <br />
    <p class="fa fa-birthday-cake" style="color:blue"> <%=Server.HtmlEncode(Session["DOB"].ToString())%></p>
    <br />
        <p class="fa fa-mobile-phone" style="color:blue"><%=Server.HtmlEncode(Session["Mobile"].ToString())%></p>
    <br />
    <br />
    <p style="color:black;font-weight:bold">Personal Info</p>
            <p class="fa fa-book" style="color:blue"><%=Server.HtmlEncode(Session["School"].ToString())%></p>
    <br />


    <p class="fa fa-university" style="color:blue"><%=Server.HtmlEncode(Session["College"].ToString())%></p>
    <br />
        <p class="fa fa-tasks" style="color:blue"><%=Server.HtmlEncode(Session["Work"].ToString())%></p>
    <br />
            <p class="fa fa-building-o" style="color:blue"><%=Server.HtmlEncode(Session["Company"].ToString())%></p>
    <br />
            <p class="fa fa-map-marker" style="color:blue"><%=Server.HtmlEncode(Session["Place"].ToString())%></p>

    <br />
    <br />

            <p class="fa fa-map-marker" style="color:blue"><%=Server.HtmlEncode(Session["Location"].ToString())%></p>
    <br />

    <p class="fa fa-location-arrow" style="color:blue"><%=Server.HtmlEncode(Session["From"].ToString())%></p>
    <br />
    <br />
        <p class="fa fa-asterisk" style="color:blue"><%=Server.HtmlEncode(Session["Religion"].ToString())%></p>
    <br />
    <br />
        <p style="color:black;font-weight:bold">Interests</p>
            <p class="fa fa-thumbs-up" style="color:blue"><%=Server.HtmlEncode(Session["Interest"].ToString())%></p>


<br />
    <br />
    <p style="color:black;font-weight:bold">Relationship</p>
            <p class="fa fa-user-circle" style="color:blue"><%=Server.HtmlEncode(Session["Relation"].ToString())%></p>
    <br />
        <p class="fa fa-heart"><%=Server.HtmlEncode(Session["Relationwith"].ToString())%></p>
                ...
                <table class="nav-justified">
                    <tr>
                        <td><span class="block"><span><span class="text-muted block">
                            <asp:Image ID="Image1" runat="server" Height="42px" ImageUrl='<%# Eval("Image") %>' Width="50px" Style="border-radius:50%;" />
                            </span></span></span></td>
                        <td>
                        ...
                        <td>
                            <asp:LinkButton ID="LinkButton1" runat="server"  CommandArgument='<%# Eval("FId") %>' CommandName="Accept"   >Accept</asp:LinkButton>
                        </td>
                        <td>
                            <asp:LinkButton ID="LinkButton2" runat="server"  CommandArgument='<%# Eval("FId") %>' CommandName="Reject"   >Reject</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
