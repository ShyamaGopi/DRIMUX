<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Timeline.aspx.cs" Inherits="User_Default" %>
...
<%--    <asp:Button ID="btn_serach" runat="server" action="post" Text="Search" OnClick="btn_serach_Click" />--%>
	...
	<asp:DataList ID="DataList1" runat="server"  RepeatColumns="1" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand"   >
            <ItemTemplate>
                ...
                <tr>
                    <td rowspan="3"><span class="block"><span><span class="text-muted block">
                        <asp:Image ID="img_propic" runat="server" Height="50px" Width="50px" ImageUrl='<%# Eval("profpic") %>' style="border-radius:50%" />
                        <asp:Label ID="lbl_name" runat="server" Font-Bold="True" Font-Size="20px" ForeColor="#0000CC" Text='<%# Eval("Firstname") %>'></asp:Label>
                        <br />
                        </span></span></span></td>
                    <td>
                       <asp:LinkButton ID="lb_show" runat="server" CommandArgument='<%# Eval("MediaId") %>' CommandName="show"  style="font-weight:bold;font-size:35px">....</asp:LinkButton></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td>
                        <asp:LinkButton ID="lb_update" runat="server" CssClass="fa fa-edit" Visible="false" CommandArgument='<%# Eval("MediaId") %>' CommandName="update" >Edit</asp:LinkButton>
                    </td>
                    <td colspan="2"></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:LinkButton ID="lb_delete" runat="server" CssClass="fa fa-trash" Visible="false" CommandArgument='<%# Eval("MediaId") %>' CommandName="delete" >Delete</asp:LinkButton>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                   </asp:Panel> 
                ...
                <tr>
                    ...
                    <td colspan="2"><span class="block"><span><span class="text-muted block">
                         <br />
                         <br />
                ...
                <tr>
                    <td colspan="2"><span class="block"><span><span class="text-muted block">
                        <br />
                        <asp:Label ID="lbl_url" runat="server" ForeColor="Black" Text='<%# Eval("Url") %>'></asp:Label>
                        </span></span></span></td>
                </tr>
                    <tr>
                        <td>&nbsp;</td>
                ...
                <tr>
                    <td colspan="3">
                        <asp:Image ID="img_photo" runat="server" Height="76px" ImageUrl='<%# Eval("Image") %>' onerror="this.src='../UserTemp/images/default.jpg'" Width="203px"  />
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    ...
                    <td>&nbsp;</td>
                                ...
                                <tr>
                    <td colspan="3">
                        <asp:TextBox ID="txt_comment" placeholder="Write a comment....." runat="server" Height="30px" Width="526px"></asp:TextBox>
                        <asp:LinkButton ID="LinkButton6" CommandArgument='<%# Eval("MediaId") %>' CommandName="Comment" Style="text-align:center;background:#2b3aa2; color: white;border-color:#2b3aa2;" runat="server" Height="24px">Comment</asp:LinkButton>
                                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
